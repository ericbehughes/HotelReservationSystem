...
public class Amex extends AbstractCreditCard implements Serializable{
	...
	/**
	 * Checks the leading number of the card to see if they match Amex
	 * regulations.
	 *
	 * @param number
	 *            the number
	...
	/**
	 * Validate the number to see if it's a valid American Express number. The
	 * validation scheme is that the first two numbers must be a 34 or 37, and
	 * the card must have 15 digits.
	 *
	 * @param number
	 *            the number
