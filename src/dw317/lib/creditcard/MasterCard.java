...
public class MasterCard extends AbstractCreditCard {
	...
	/**
	 * This method evaluates the two first numbers of the entered credit card,
	 * to see if it complies with a valid MasterCard. This is the first check to
	 * see if the card works.
	 * 
	 * @param number
	 *            - The number of the credit card
	 * @return boolean - The value that determines if the two starting digits of
	 *         the card comply with the norms of MasterCard
	 */
	...
	/**
	 * Validates the number to check if it's a valid credit card number. The
	 * validation scheme is that the first number must be a 5, and then follow
	 * up with any number from 1 - 5, and the number must be 16 digits long.
	 *
	 * @param number
	 *            the number
