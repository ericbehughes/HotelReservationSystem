...
public enum DawsonHotelFactory implements HotelFactory {
		...
		/* (non-Javadoc)
		 * @see dw317.hotel.business.interfaces.HotelFactory#getCustomerInstance(java.lang.String, java.lang.String, dw317.lib.Email, java.util.Optional)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see dw317.hotel.business.interfaces.HotelFactory#getCard(java.lang.String, java.lang.String)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see dw317.hotel.business.interfaces.HotelFactory#getRoomInstance(int, java.lang.String)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see dw317.hotel.business.interfaces.HotelFactory#getReservationInstance(dw317.hotel.business.interfaces.Customer, dw317.hotel.business.interfaces.Room, int, int, int, int, int, int)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see dw317.hotel.business.interfaces.HotelFactory#getReservationInstance(dw317.hotel.business.interfaces.Reservation)
		 */
		@Override
